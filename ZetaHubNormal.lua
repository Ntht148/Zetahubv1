...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Shop Bán Acc-Ugphone-Script Giá Rẻ" , 6 ,11816162894 )
...
Setting:Label("Đây Script Normal | Script Premium Đang Bảo Trì")
...
Setting:Button("Sao Chép Link Shop",function()
 ...
 setclipboard("https://ZTshop.site")
  DiscordLib:Notification("Thông Báo" , "Đã Sao Chép Link Shop" , 10 ,11816162894 )
 end)
...
Setting:Toggle("Screen White [ Mượt Hơn ]",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("Đồ Hoạ Fifai",function()
...
local SelectWeapona = Main:Dropdown("Weapon",WeaponList,function(value)
...
Main:Toggle("Auto Factory",_G.AutoFactory,function(value)
...
Main:Toggle("Kill All Boss ",_G.Auto_Farm_All_Boss,function(value)
...
Main:Seperator("Chest")    
    Main:Toggle("Auto Chest ( 95% Reset Acc )",_G.chestsea2,function(value)
 _G.chestsea2 = value
...
Main:Toggle("Auto Bone",_G.Auto_Farm_Bone,function(value)
...
Main:Toggle( "Check Katakuri+Spawn Boss" ,_G.Auto_Cake_Pr1ince,function(value)
...
Main:Toggle("Auto Katakuri",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Main:Toggle("Auto Katakuri V2",_G.Auto_Open_Dough_Dungeon,function(value)
...
StopTween(_G.Auto_Elite_Hunter)
	...
	Weapon:Toggle("Elite Hunter Hop",_G.Auto_Elite_Hunter_Hop,function(value)
...
Weapon:Toggle("Auto sgt",_G.AutoNevaSoulGuitar,function(value)
...
if World3 then
Weapon:Toggle("Soul Guitar Hop",false,function(value)
...
if World3 then
Weapon:Toggle("Auto Cdk",_G.songkiem,function(autocdkf)
...
Weapon:Toggle("Auto Buy Sword Legendary",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("Sword Legendary Hop",_G.AutoBuySwordHop,function(Value)
...
Weapon:Seperator(" Haki Màu ")
	...
	Weapon:Toggle("Auto Buy Haki",_G.Auto_Buy_Enchancement,function(value)
...
StopTween(_G.Auto_Buy_Enchancement)
	...
	Weapon:Toggle("AutoRengoku",_G.Auto_Rengoku,function(value)
...
Weapon:Toggle("Auto Reaper",_G.Auto_Soul_Reaper,function(value)
...
Weapon:Toggle("Random Bone Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Canvander)
	...
	Weapon:Toggle("Canvander Hop",_G.Auto_Canvander_Hop,function(value)
...
StopTween(_G.Auto_Twin_Hook)
	...
	Weapon:Toggle("Twin Hook Hop",_G.Auto_Twin_Hook_Hop,function(value)
...
StopTween(_G.Auto_Serpent_Bow)
	...
	Weapon:Toggle("Serpent Bow Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("Auto Torch",_G.Auto_Holy_Torch,function(value)
...
Weapon:Toggle("Auto Haki v2",_G.AutoObservationHakiV2,function(x)
...
Race:Button("Nhặt Gear",function()
    ...
    if v.Name:find("Part") and v.ClassName == "MeshPart" then
        ...
        Race:Button("Auto Chest Đảo Bí Ẩn",function()
